...
\pravilo{Konjunkcija} 
Pravilo vpeljave za konjunkcijo pravi, če sta izjavi \(A\) in \(B\) resični, potem je tudi izjava \(A\) in \(B\) resnična. To lahko zapišemo kot
%
\begin{prooftree}
    \AXC{\(A\) \tru}
    \AXC{\(B\) \tru}
...
\end{prooftree}
%
Zgornje pravilo preberemo kot, če imamo poljubni resnični izjavi \(A\) in \(B\), potem v tem kontekstu velja tudi \(A \land B\).

Za konjunkcijo imamo dva pravila uporabe (ang.~elimination rule) --- levo in desno.
%
\begin{equation*}
    \begin{bprooftree}
...
Preden nadaljujemo na primer kako lahko izpeljemo implikacijo, si moramo pogledati eno od osnovnih pravil sklepanja in sicer pravilo aksioma.
%
\begin{prooftree}
    \AXC{}
    \RL{\emph{Ax}}
